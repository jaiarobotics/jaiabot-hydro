                ...
                >
                    ...
                    >
                        <div className="runTitleBar">
                            <Typography className="title">{this.props.run.name}</Typography>
                            <div className="botName">{this.getBotName()}</div>
                        </div>
                    </AccordionSummary>
                    <AccordionDetails>
                            ...
                            <table className="table-container">
                                ...
                                <tbody>
                                    {this.props.run.command.plan.goal.map((item, index) => (
                                        <tr key={index}>
                                            <td>{index + 1}</td>
                                            <td>{item.location.lat.toFixed(5)}</td>
                                            <td>{item.location.lon.toFixed(5)}</td>
                                            <td>{item.task?.type ? item.task.type : "None"}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
