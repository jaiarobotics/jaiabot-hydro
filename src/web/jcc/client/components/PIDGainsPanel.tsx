                        ...
                        <table id="engineering_requirements_table">
                            <tbody>
                                <tr>
                                    ...
                                    <td key="current_status_rate">{showRate}</td>
                                </tr>
                                <tr>
                        ...
                        <table id="engineering_safety_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        key="current_bottom_depth_safety_heading"
                                        style={{ maxWidth: "80px" }}
                                    >
                                ...
                                <tr>
                                    ...
                                    <td
                                        key="current_bottom_depth_safety_time"
                                        style={{ maxWidth: "80px" }}
                                    >
                                        {engineering?.bottom_depth_safety_params
                                ...
                                <tr>
                                    <td key="current_bottom_depth_safety_speed_label">
                                        Current Depth Safety Speed
                                    </td>
                                    <td
                                        key="current_bottom_depth_safety_speed"
                                        style={{ maxWidth: "80px" }}
                                    >
                                        {engineering?.bottom_depth_safety_params
    ...
    submitBotRequirements() {
        this.props.control(() => {
            ...
            if (getValueOfInput("status_rate_input") != -1) {
                bot_status_rate_change = getStringValueOfInput(
                    "status_rate_input",
                ) as BotStatusRate;
            }
            ...
            let engineeringCommand: Engineering = {
                ...
                gps_requirements: {
                    ...
                    transit_gps_degraded_fix_checks: getValueOfInput(
                        "transit_gps_degraded_checks_input",
                    ),
