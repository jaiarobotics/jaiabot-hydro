...
class AtlasOEM:
    ...
    def calibrationRequest(self):
        return self.readUnsignedByte(0x0c)


    # Calibration confirmation
    def calibrationConfirmation(self):
        return self.readUnsignedByte(0x0d)
    ...
    def dump(self):
        ...
        print(f'Calibration Request:      {self.calibrationRequest():0.2f}')
        ...
        print(f'pH                        {self.PH():0.2f}')
        

while True:
    try:
        probe = AtlasOEM(address=0x65, devType=0x01)
...
def lowCalibration():
    doCalibration('DUAL POINT LOW', 2)
...
def calibrate():
    presentMenu({
        ...
        'items': [
            ...
            {
                'description': 'Mid Calibration',
                'key': 'd',
                'func': midCalibration
            },
            {
                'description': 'Three-Point Low Calibration',
                'key': 'l',
                'func': lowCalibration
            },
            {
                'description': 'Three-Point High Calibration',
                'key': 'h',
