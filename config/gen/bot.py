...
{ 'gobyd':                                        { 'runtime': { 'tty': 'WARN', 'log': 'WARN'  }, 'simulation': { 'tty': 'WARN', 'log': 'WARN' }},
  ...
  'jaiabot_aml_x2change_sensor_driver':           { 'runtime': { 'tty': 'WARN', 'log': 'WARN' },  'simulation': { 'tty': 'WARN', 'log': 'QUIET' }}
}
...
elif common.app == 'jaiabot_aml_x2change_sensor_driver':
    print(config.template_substitute(templates_dir+'/bot/jaiabot_aml_x2change_sensor_driver.pb.cfg.in',
                                     app_block=app_common,
                                     interprocess_block = interprocess_common))
